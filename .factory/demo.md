...
Open `/demo/` or use the first-screen **Try it with sample data** link. `/?demo=1` remains a direct isolated sample URL. The demo opens directly on its populated forecast, not the landing hero.
